...
namespace Labs_Yolo3
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            using var origImg = new Mat("03.jpg");
            ...
            var blob = CvDnn.BlobFromImage(finalImg, 1.0 / 255, new Size(416, 416), new Scalar(), true, false);
            ...
            GetResult(outs, finalImg, threshold, nmsThreshold);

            using (new Window("El Bruno - OpenCV Yolo3", finalImg))
            {
                Cv2.WaitKey();
            }
        }
