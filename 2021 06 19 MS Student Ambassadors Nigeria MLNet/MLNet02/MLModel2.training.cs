...
namespace MLNet02
{
    public partial class MLModel2
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.LoadImages(@"input1", @"ImageSource")      
                                    ...
                                    .Append(mlContext.Transforms.ApplyOnnxModel(modelFile:@"d:\src\eb\tests\20210619 MS Student Ambassadors Nigeria MLNet\MLNet02\MLModel2.onnx"));
