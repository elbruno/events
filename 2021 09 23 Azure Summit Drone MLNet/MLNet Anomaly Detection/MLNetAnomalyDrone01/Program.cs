...
namespace MLNetAnomalyDrone01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var estimator = mlContext.Transforms.DetectIidSpike(outputColumnName: nameof(DronePrediction.Prediction), inputColumnName: nameof(DroneData.agz),
                confidence: 95, 
                pvalueHistoryLength: size / 5);
