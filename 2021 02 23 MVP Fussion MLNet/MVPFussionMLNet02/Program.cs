...
namespace MVPFussionMLNet02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // load data
            var dataView = mlContext.Data.LoadFromTextFile<ProductSalesData>(path: "product-sales.csv", hasHeader: true,
                separatorChar: ',');
            ...
            var estimator = mlContext.Transforms.DetectIidSpike(
                ...
                confidence: 80, pvalueHistoryLength: size / 4);
