...
using MUG_MLNetML.Model;

namespace MUG_MLNetML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\src\eb\tests\20200731 MUG MLNet\DataSamples\SentimentAnalysis\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\bruno\AppData\Local\Temp\MLVSTools\MUG MLNetML\MUG MLNetML.Model\MLModel.zip";
