...
namespace TechDay_ConfML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\src\eb\tests\20200229 TechDay Conf MLNet\Shared\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"../../../../TechDay_ConfML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.3252185f, L1Regularization = 0.8645244f, OptimizationTolerance = 0.0001f, HistorySize = 20, MaximumNumberOfIterations = 1406886451, InitialWeightsDiameter = 0.4852798f, DenseOptimizer = false, LabelColumnName = "Label", FeatureColumnName = "Features" });
