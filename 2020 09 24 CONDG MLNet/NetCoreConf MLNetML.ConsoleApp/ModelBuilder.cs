...
using NetCoreConf_MLNetML.Model;

namespace NetCoreConf_MLNetML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\src\eb\tests\20200404 NetCoreConf MLNet\Shared\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\bruno\AppData\Local\Temp\MLVSTools\NetCoreConf MLNetML\NetCoreConf MLNetML.Model\MLModel.zip";
