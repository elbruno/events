...
using CatchIt_MLNetML.Model;

namespace CatchIt_MLNetML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\src\eb\tests\20200410 CatchIt MLNet\Shared\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\bruno\AppData\Local\Temp\MLVSTools\CatchIt MLNetML\CatchIt MLNetML.Model\MLModel.zip";
