...
using CONDG_MLNetML.Model;

namespace CONDG_MLNetML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\src\eb\tests\20200924 CONDG MLNet\Shared\wikiDetoxAnnotated40kRows.tsv";
