...
namespace MLNet_NetCoreConf_03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var estimator = mlContext.Transforms.DetectIidSpike(outputColumnName: nameof(ProductSalesPrediction.Prediction), inputColumnName: nameof(ProductSalesData.numSales), confidence: 95, pvalueHistoryLength: size / 2);
