...
namespace ConsoleAppMlNetKaggleDataSet
{
   ...
   {
        private static string DatasetRelativePath = $"conn250K.csv";
        ...
        static void Main()
        {
            ...
            const int size = 256670;

            //Load the data into IDataView.
            //This dataset is used while prediction/detecting spikes or changes.
            IDataView dataView = mlContext.Data.LoadFromTextFile<KaggleItemData>(path: DatasetPath, hasHeader: false, separatorChar: ',');
        ...
        static void DetectSpike(int size,IDataView dataView)
        {
           Console.WriteLine("===============Detect temporary changes in pattern===============");
            ...
            var estimator = mlContext.Transforms.DetectIidSpike(outputColumnName: nameof(KaggleItemPrediction.Prediction), inputColumnName: nameof(KaggleItemData.itemValue),confidence: 95, pvalueHistoryLength: size / 400);
            ...
            var predictions = mlContext.Data.CreateEnumerable<KaggleItemPrediction>(transformedData, reuseRowObject: false);
        ...
        static void DetectChangepoint(int size, IDataView dataView)
        {
          ...
          var estimator = mlContext.Transforms.DetectIidChangePoint(outputColumnName: nameof(KaggleItemPrediction.Prediction), inputColumnName: nameof(KaggleItemData.itemValue), confidence: 95, changeHistoryLength: size / 4);
          ...
          Console.WriteLine($"{nameof(KaggleItemPrediction.Prediction)} column obtained post-transformation.");
        ...
        private static IDataView CreateEmptyDataView()
        {
            ...
            IEnumerable<KaggleItemData> enumerableData = new List<KaggleItemData>();
