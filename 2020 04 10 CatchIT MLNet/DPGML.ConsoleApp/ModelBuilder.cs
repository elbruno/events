...
namespace DPGML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\src\eb\tests\20200121 DPG MLNet\Shared\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"../../../../DPGML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("comment_tf", "comment")
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "comment_tf", "year" }))
